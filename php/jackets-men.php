...
<body>
    ...
    <!-- Side navigation -->
    <div class="sidenav">
        <h2 style="padding-left: 10px;"><strong>Jackets Section</strong></h2>
    ...
    <div class="sidenav2">
        <h2 style="padding-left: 10px;"><strong>Men clothes</strong></h2>
        <a href="tops-men.php" >Tops</a><br><br>
        <a href="pants-men.php" >Pants</a><br><br>
        <a href="jackets-men.php" >Sweaters</a><br><br>
        <a href="shoes-men.php" >Shoes</a><br><br>
        <a href="accessories-men.php" >Accessories</a><br><br>
    </div>
...
{   
    ...
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6">
                 <img src="../images/jackM' . $item['image'] . '" alt="imgJacketsM">
                 <h3>' . $item['name'] . '</h3>
