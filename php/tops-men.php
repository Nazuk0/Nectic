...
<body>
    ...
    <div class="sidenav">
        ...
        <a href="#" data-filter=".tanktops">Tank Tops</a><br><br>
        <a href="#" data-filter=".tshirts">T-Shirts</a><br><br>
        <a href="#" data-filter=".shirts">Shirts</a><br><br>
        <a href="#" data-filter=".dressshirts">Dress Shirts</a>
    </div>
    <div class="sidenav2">
...
{   
    ...
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6">
                 <img src="../images/topsM' . $item['image'] . '" alt="imgTopsM">
                 <h3>' . $item['name'] . '</h3>
