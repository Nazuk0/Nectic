...
<body>
    ...
    <!-- Side navigation -->
    <div class="sidenav">
        <h2><strong>Tops Section</strong></h2>
        <a href="#" data-filter="*">All</a><br><br>
        <a href="#" data-filter=".Tank">Tank Tops</a><br><br>
        <a href="#" data-filter=".T-Shirt" class="current">T-Shirts</a><br><br>
        <a href="#" data-filter=".Shirt">Shirts</a><br><br>
        <a href="#" data-filter=".Crop">Crop Top</a>
    </div>
    <div class="sidenav2">
        <h2><strong>Women clothes</strong></h2>
        <a href="pants-women.php" >Pants</a><br><br>
        <a href="sweaters-women.php" >Sweaters</a><br><br>
        <a href="sweaters-women.php" >Jackets &amp; Coats</a><br><br>
...
{   
    ...
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6 ' . $item['name'] .'">
                 <img src="../images/TopsW/' . $item['image'] . '" alt="imgTopsM">
                 <div class="overlay">
