...
<body>
    ...
    <!-- Side navigation -->
    <div class="sidenav">
        <h2><strong>Sweaters Section</strong></h2>
        <a href="#" data-filter="*">All</a><br><br>
        <a href="#" data-filter=".Hoodie">Hoodie</a><br><br>
        <a href="#" data-filter=".Cardigan">Cardigan</a><br><br>
        <a href="#" data-filter=".Pullover">Pullover</a><br><br>
        <a href="#" data-filter=".Sweater">Sweater</a><br><br>
    </div>
    <div class="sidenav2">
        <h2><strong>Women clothes</strong></h2>
        <a href="tops-women.php">Tops</a><br><br>
        <a href="pants-women.php">Pants</a><br><br>
        <a href="jackets-women.php" data-filter=".parka">Jackets &amp; Coats</a><br><br>
...
{   
    ...
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6 ' . $item['name'] .'">
                 <img src="../images/sweatW/' . $item['image'] . '" alt="imgSweatW">
                 <div class="overlay">
