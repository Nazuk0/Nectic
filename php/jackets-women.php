...
<body>
    ...
    <!-- Side navigation -->
    <div class="sidenav">
        <h2><strong>Jackets Section</strong></h2>
        <a href="#" data-filter="*">All</a><br><br>
        <a href="#" data-filter=".Leather">Leather</a><br><br>
        <a href="#" data-filter=".Trench">Trench coat</a><br><br>
        <a href="#" data-filter=".Parka">Parka</a><br><br>
    </div>
    <div class="sidenav2">
        <h2><strong>Women clothes</strong></h2>
        <a href="tops-women.php" >Tops</a><br><br>
        <a href="pants-women.php" >Pants</a><br><br>
        <a href="jackets-women.php" >Sweaters</a><br><br>
...
{     
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6 ' . $item['name'] .'">
                 <img src="../images/jackW/' . $item['image'] . '" alt="imgJacketsW">
                 <div class="overlay">
