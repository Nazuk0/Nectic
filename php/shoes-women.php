...
<body>
    ...
    <nav id="navbar" class="navbar navbar-inverse data-spy="
         data-offset-top="20">
    ...
    <!-- Side navigation -->
    <div class="sidenav">
        <h2><strong>Shoes Section</strong></h2>
        <a href="#" data-filter="*">All</a><br><br>
        <a href="#" data-filter=".Formal">Formal</a><br><br>
        <a href="#" data-filter=".Sneakers">Sneakers</a><br><br>
        <a href="#" data-filter=".Flat">Flat</a><br><br>
        <a href="#" data-filter=".Boots">Boots</a><br><br>
    </div>
    <div class="sidenav2">
        <h2><strong>Women clothes</strong></h2>
        <a href="tops-women.php" >Tops</a><br><br>
        <a href="pants-women.php" >Pants</a><br><br>
...
$categories = $statement->fetchAll();
    ...
    $statement = $db->prepare('SELECT * FROM items WHERE items.category = 5');
...
{   
    ...
    while($item = $statement->fetch())
    {
             echo '<div class="col-lg-3 col-md-4 col-sm-6 ' . $item['name'] .'">
                 <img src="../images/shoesW/' . $item['image'] . '" alt="imgShoesW">
                 <div class="overlay">
